...
<html>
    <script type="text/javascript">
        function excluir(nome, id) {
            if (confirm("Tem certeza que deseja excluir o usuário:" + nome + "?")) {
                window.open("excluir_funcionario.do?op=c&id=" + id, "_self");
            }
        }
    </script>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="pl-2">
                <a href="form_inserir_funcionario.jsp" class="btn btn-primary mt-2 mb-2">Novo Funcionário</a>
            </div>
                ...
                <table class="table table-sm table-hover">
                    ...
                    <tbody class="text-center">
                        <tr>
                            ...
                            <td>
                                <a href="form_alterar_funcionario.jsp?id=<%=f.getId()%>" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></a> 
