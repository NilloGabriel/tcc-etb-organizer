<%-- 
    Document   : login
    Created on : 01/10/2019, 15:13:22
        ...
        <div class="container h-100">
            <div class="d-flex justify-content-center h-100">
                <div class="user_card">
                    ...
                    <form name="login" action="login_dentista.jsp" method="post">
                        <div class="d-flex justify-content-center mt-3 login_container">
                            <input type="submit" name="button" class="btn btn-danger" value="Ir para Login Destista">
                        </div>
                    </form>
                </div>
            </div>
