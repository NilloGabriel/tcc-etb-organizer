    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                double valor_consulta = Double.parseDouble(request.getParameter("valor_consulta"));
                String tipo_pagamento = request.getParameter("tipo_pagamento");
                if(!tipo_pagamento.isEmpty() ){
                    Consulta c = new Consulta(); 
                    ConsultaDAO cDAO = new ConsultaDAO();
                    c.setId(id_consulta);
                    c.setValor_consulta(valor_consulta);
                    c.setTipo_pagamento(tipo_pagamento);
                    cDAO.registrarDataValorPagamentoTipo(c);
